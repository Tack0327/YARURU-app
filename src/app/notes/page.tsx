...
function NoteEditContent() {
  ...
  return (
    <div className="flex flex-col gap-5">
      ...
      <div>
        <label htmlFor="note-title" className="mb-1 block text-sm font-medium text-gray-300">
          タイトル
        </label>
        <input
          id="note-title"
      ...
      <div className="flex flex-1 flex-col">
        <label htmlFor="note-content" className="mb-1 block text-sm font-medium text-gray-300">
          詳細
        </label>
        <textarea
          id="note-content"
          ...
          className="min-h-[60vh] w-full flex-1 rounded-lg border border-gray-600 bg-gray-800 px-4 py-3 text-base text-gray-100 focus:border-blue-500"
        />
      </div>
